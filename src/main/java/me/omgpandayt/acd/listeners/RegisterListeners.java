...
public class RegisterListeners implements Listener {
    ...
    public void onDamage(EntityDamageByEntityEvent e) {
        ...
        PlayerDataManager.getPlayer((Player) e.getEntity()).setTicksSinceHit(0);
    }
    ...
    public void onMove(PlayerMoveEvent e) {
        ...
        for (Entity entity : e.getPlayer().getNearbyEntities(2, 2, 2)) {
            if (entity instanceof Boat) {
                playerData.setLastPacketNearBoat(true);
            }
        }
    }
    ...
    public void onUse(PlayerInteractEvent e) {
        ...
        PlayerDataManager.getPlayer(e.getPlayer()).setTicksSinceRocket(0);
    ...
    public boolean bypass(Player p) {
        ...
        return playerData.getTicksLived() <= ACD.getInstance().getConfig().getDouble("main.join-bypass-ticks") || p.hasPermission("acd.bypass");
    }
